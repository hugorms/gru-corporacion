...
const FloatingWhatsApp = () => {
  ...
  const phoneNumber = '584129590954'; // WhatsApp: +58 412 959 0954
  ...
  return (
    ...
    >
      <motion.div
        ...
        whileHover={{ 
          scale: 1.1,
          boxShadow: '0 20px 25px -5px rgba(37, 211, 102, 0.4), 0 10px 10px -5px rgba(37, 211, 102, 0.3)'
        }}
        whileTap={{ scale: 0.95 }}
      ...
      {/* Pulse animation ring - positioned behind button */}
      <motion.div
